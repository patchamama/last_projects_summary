...
## 6. 📁 [Hyper-V-Guest-Configurator](https://github.com/patchamama/Hyper-V-Guest-Configurator)
🗓️ **2026-04-24 → 2026-05-07** · 💻 **Languages:** PowerShell · 🧩 **Frameworks:** None detected
🌐 **Deploy / Pages:** —

PowerShell automation for preparing and provisioning Windows Hyper-V guest VMs. - Configures VM prerequisites for WSL2 (including nested virtualization).
...
## 7. 📁 [Notes_IA_Installations_Prompt_Mieles](https://github.com/patchamama/Notes_IA_Installations_Prompt_Mieles)
🗓️ **2026-04-03 → 2026-05-06** · 💻 **Languages:** PowerShell · 🧩 **Frameworks:** None detected
🌐 **Deploy / Pages:** —

ollama pull hf.co/unsloth/GLM-4.7-Flash-GGUF:UD-Q4_K_XL ollama run qwen3.6:27b-coding-nvfp4
...
## 8. 📁 [LocalForge_Ollama-Local-SSL](https://github.com/patchamama/LocalForge_Ollama-Local-SSL)
...
## 11. 📁 [Bigdump-customized-for-wordpress](https://github.com/patchamama/Bigdump-customized-for-wordpress)
...
## 12. 📁 [code-patrol](https://github.com/patchamama/code-patrol)
...
## 15. 📁 [Chess-API-Example](https://github.com/patchamama/Chess-API-Example)
🗓️ **2025-10-29 → 2026-01-23** · 💻 **Languages:** HTML, Python, Shell · 🧩 **Frameworks:** Flask
🌐 **Deploy / Pages:** —

- Running the Project - API Documentation (Swagger UI)
...
## 16. 📁 [Interactive-Video-Navigator](https://github.com/patchamama/Interactive-Video-Navigator)
...
## 18. 📁 [Gtranslate_bookmarket](https://github.com/patchamama/Gtranslate_bookmarket)
🗓️ **2025-11-17 → 2025-11-18** · 💻 **Languages:** JavaScript · 🧩 **Frameworks:** None detected
🌐 **Deploy / Pages:** —

> A powerful browser bookmarklet that enhances Google Translate with history tracking, smart language rotation, and advanced features. **Last Updated:** 2024-11-17
...
## 20. 📁 [Voting_example_go_vanillaJS](https://github.com/patchamama/Voting_example_go_vanillaJS)
...
## 21. 📁 [Voting_App_Example_Django_React](https://github.com/patchamama/Voting_App_Example_Django_React)
🗓️ **2025-10-26 → 2025-10-27** · 💻 **Languages:** Python, TypeScript, HTML, CSS · 🧩 **Frameworks:** Django
🌐 **Deploy / Pages:** —

This project implements a simple voting system using Django, Django REST Framework, and Swagger UI. It provides both a traditional web interface and a RESTful API for interacting with the voting system.
...
## 25. 📁 [AI-on-Mail](https://github.com/patchamama/AI-on-Mail)
...
## 27. 📁 [Bookstore-loans](https://github.com/patchamama/Bookstore-loans)
...
## 29. 📁 [deepseek-pdf-chat](https://github.com/patchamama/deepseek-pdf-chat)
🗓️ **2025-02-03 → 2025-02-03** · 💻 **Languages:** Python · 🧩 **Frameworks:** Streamlit
🌐 **Deploy / Pages:** —
...
## 35. 📁 [test-con-michael](https://github.com/patchamama/test-con-michael)
🗓️ **2024-11-12 → 2024-11-13** · 💻 **Languages:** HTML · 🧩 **Frameworks:** None detected
🌐 **Deploy / Pages:** —

> Estos comandos se usan para usar sin crear ninguna rama (branch) usando por defecto la rama `main` o la que esté por defecto desde github. git commit -m "message"
...
## 36. 📁 [devtalles-principios-solid-clean-code](https://github.com/patchamama/devtalles-principios-solid-clean-code)
🗓️ **2023-12-09 → 2024-11-05** · 💻 **Languages:** TypeScript, JavaScript, HTML, CSS · 🧩 **Frameworks:** None detected
🌐 **Deploy / Pages:** —

- https://github.com/ryanmcdermott/clean-code-javascript - https://github.com/devictoribero/clean-code-javascript
...
## 39. 📁 [chess-ebook-webparser](https://github.com/patchamama/chess-ebook-webparser)
...
## 40. 📁 [Simple-Video_podcast-generator](https://github.com/patchamama/Simple-Video_podcast-generator)
...
## 41. 📁 [GutenbergOnMail](https://github.com/patchamama/GutenbergOnMail)
🗓️ **2023-04-17 → 2024-09-08** · 💻 **Languages:** Python, HTML, Dockerfile, JavaScript · 🧩 **Frameworks:** None detected
🌐 **Deploy / Pages:** [https://gutenberg-on-mail.herokuapp.com/](https://gutenberg-on-mail.herokuapp.com/) | [https://pep8ci.herokuapp.com/](https://pep8ci.herokuapp.com/)

Welcome to my third project of the Code Institute! I'm happy to meet my third challenge of the Code Institute of Python Essentials.
...
## 43. 📁 [devtalles-Visual_Studio_Code_Mejora_tu_velocidad_para_codificar](https://github.com/patchamama/devtalles-Visual_Studio_Code_Mejora_tu_velocidad_para_codificar)
🗓️ **2024-03-27 → 2024-08-09** · 💻 **Languages:** CSS, TypeScript, HTML · 🧩 **Frameworks:** None detected
🌐 **Deploy / Pages:** —

Fuente del curso: https://cursos.devtalles.com/courses/take/visual-studio-code/lessons/44761313-mis-recomendaciones-iniciales - Tips and Tricks - Oficial
